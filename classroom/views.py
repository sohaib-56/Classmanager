...
def StudentSignUp(request):
    ...
    return render(request,'classroom/signup_student.html',{'user_form':user_form,'student_profile_form':student_profile_form,'registered':registered,'user_type':user_type})
